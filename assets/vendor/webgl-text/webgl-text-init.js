    ...
    function draw(time) {
      ...
      sources.forEach(function (el, i) {
        ...
        ctx.font =
          ...
          " " +
          fontSize +
          'px "Humane", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif';
      ...
      lines.forEach(function (line) {
        if (line.metrics && line.metrics.width > maxLineWidth)
      ...
      lines.forEach(function (line, i) {
        ...
        for (var c = 0; c < txt.length; c++) {
          ...
          var cx = x + offset + w / 2;
          var sway =
            Math.sin(time * 0.002 + c * 0.4 + i * 0.5) * (fontSize * 0.08);
          ctx.save();
          ctx.translate(cx, 0);
